package scha.efer.honey.tab.task;
 ...
 */
public class HoneyTask extends BukkitRunnable {

    private final Honey azazel;

    public HoneyTask(Honey azazel, JavaPlugin plugin) {
        this.azazel = azazel;
    ...
    public void run() {
        ...
        if (adapter != null) {
            for (Player player : Bukkit.getOnlinePlayers()) {
                ...
                if (tab != null) {
                    HoneyTemplate template = adapter.getTemplate(player);
